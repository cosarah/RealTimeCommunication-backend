...
MAX_NAME_LENGTH = 16 # 用户名、昵称、好友标签、好友备注名、群聊名、群昵称、群昵称最大长度
MAX_INFO_LENGTH = 40 # 地址信息、个人简介、好友描述信息(description)、好友申请信息、群公告、群聊申请信息最大长度
MAX_PASSWORD_LENGTH = 25 # 密码最大长度
